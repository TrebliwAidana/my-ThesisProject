...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gold-200 dark:border-gold-800 p-4">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Recent Logins (7 days)</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats->recent_logins ?? 0 }}</p>
                </div>
