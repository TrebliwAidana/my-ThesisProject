...
>
    ...
    <div class="max-w-2xl space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gold-200 dark:border-gold-800 overflow-hidden shadow-sm">
            ...
            {{-- Theme picker --}}
            <div class="px-5 py-5 border-b border-gray-100 dark:border-gold-800">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <button
                        ...
                        :class="selectedTheme === '{{ $t['key'] }}' ? 'ring-2 ring-offset-2 ring-primary-500 scale-110' : 'ring-1 ring-gray-200 dark:ring-gray-600 hover:scale-105'"
                ...
                {{-- Live preview strip --}}
                <div class="mt-4 rounded-lg overflow-hidden border border-gold-200 dark:border-gold-800 flex h-10">
            ...
            <div class="px-5 py-4 flex items-center gap-3 bg-gray-50 dark:bg-gray-800/50">
                <button
                    ...
                    @click="saveTheme()"
                    :disabled="saving"
                    class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-primary-600 hover:bg-gold-500 text-white disabled:opacity-50 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-[1.02]"
                >
            ...
            <div class="px-5 py-5">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <a href="{{ route('admin.users.index') }}" 
                       class="flex items-center gap-3 p-3 rounded-lg border border-gold-200 dark:border-gold-800 hover:bg-primary-50 dark:hover:bg-primary-900/20 transition group">
