...
<div class="max-w-3xl mx-auto" x-data="memberCreateForm()" x-init="init()">
    ...
    <form method="POST" action="{{ route('members.store') }}" class="space-y-6" enctype="multipart/form-data">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-emerald-200 dark:border-emerald-800 overflow-hidden">
            <div class="px-6 py-4 border-b border-emerald-200 dark:border-emerald-800 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">Personal and account details</p>
                </div>
            </div>
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="first_name" value="{{ old('first_name') }}" required
                               class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 {{ $errors->has('first_name') ? 'border-red-400' : '' }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="last_name" value="{{ old('last_name') }}" required
                               class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 {{ $errors->has('last_name') ? 'border-red-400' : '' }}">
                ...
                <div>
                    ...
                    <input type="text" name="middle_name" value="{{ old('middle_name') }}"
                           class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
                </div>
                ...
                <div>
                    ...
                    <select name="gender" required
                            class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 {{ $errors->has('gender') ? 'border-red-400' : '' }}">
                ...
                <div>
                    ...
                    <div class="flex">
                        ...
                        <input type="tel" name="phone" value="{{ old('phone') }}"
                               ...
                               class="flex-1 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-r-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 {{ $errors->has('phone') ? 'border-red-400' : '' }}">
                    </div>
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required
                           class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 {{ $errors->has('email') ? 'border-red-400' : '' }}">
                ...
                <div>
                    ...
                    <select name="role_id"
                            ...
                            required
                            class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 {{ $errors->has('role_id') ? 'border-red-400' : '' }}">
                ...
                <div>
                    ...
                    {{-- Placeholder while no role selected --}}
                ...
                <div>
                    ...
                    <input type="text" name="student_id" value="{{ old('student_id') }}" placeholder="2020-12345"
                           class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 {{ $errors->has('student_id') ? 'border-red-400' : '' }}">
                ...
                <div>
                    ...
                    <input type="file" name="avatar" accept="image/*"
                           class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-emerald-200 dark:border-emerald-800 overflow-hidden">
            <div class="px-6 py-4 border-b border-emerald-200 dark:border-emerald-800 flex items-center gap-3">
                ...
                <div>
                    <h2 class="font-semibold text-gray-900 dark:text-white">Membership Details</h2>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Term and joining information</p>
                </div>
            </div>
        ...
        <div class="flex justify-between items-center gap-3">
            <button type="submit"
                    class="bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold px-6 py-2.5 rounded-lg transition shadow-sm">
                Create Member
            </button>
