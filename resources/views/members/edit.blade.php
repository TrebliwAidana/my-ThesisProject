            ...
            <div class="mb-6">
                ...
                <div class="flex gap-4">
                    <label class="inline-flex items-center gap-2">
                        <input type="radio" name="is_active" value="1" {{ old('is_active', $user->is_active) == 1 ? 'checked' : '' }} class="text-gold-600 focus:ring-gold-500">
                        <span>Active</span>
                    </label>
                    <label class="inline-flex items-center gap-2">
                        <input type="radio" name="is_active" value="0" {{ old('is_active', $user->is_active) == 0 ? 'checked' : '' }} class="text-gold-600 focus:ring-gold-500">
                        <span>Inactive</span>
                    </label>
                </div>
            </div>
