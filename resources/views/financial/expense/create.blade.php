...
@section('title', 'Add Expense — VSULHS SSLG')
@section('page-title', 'Add Expense')

@push('styles')
<style>
/* ════════════════════════════════════════════════
   ADD EXPENSE — Emerald & Gold Luxury Theme
...
<div class="space-y-5">
    ...
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-600 to-emerald-700 dark:from-emerald-800 dark:to-emerald-900 p-6 md:p-7">
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-white tracking-tight">Add Expense</h1>
            <p class="text-emerald-100/80 text-sm mt-1.5 max-w-lg">Record cash paid out for expenses</p>
        </div>
    </div>

    {{-- Form Card --}}
    <div class="form-container anim-2" x-data="expenseForm()">
        <div class="form-card">
