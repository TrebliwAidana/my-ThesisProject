...
class DocumentController extends Controller
{
    ...
    {
        $query = Document::with(['currentVersion', 'owner', 'category'])->latest();
        ...
        $autoGeneratedCount = Document::whereJsonContains('tags', 'auto-generated')->count();
        $totalCount         = Document::count();
        $incomeCount        = Document::whereHas('category', fn($q) => $q->where('name', 'Approved Income'))->count();
        $expenseCount       = Document::whereHas('category', fn($q) => $q->where('name', 'Approved Expense'))->count();
        $receivableCount    = Document::whereHas('category', fn($q) => $q->where('name', 'Approved Receivable'))->count();
