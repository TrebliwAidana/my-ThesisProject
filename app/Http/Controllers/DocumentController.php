...
class DocumentController extends Controller
{
    ...
    {
        // Pre-fetch category IDs to eliminate correlated subqueries
        ...
        // Apply same filters to stats query for consistency
        ...
        ', [$incomeCategory?->id, $expenseCategory?->id, $receivableCategory?->id])->first();
